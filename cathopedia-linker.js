( function ( element, editor, richText ) {
    ...
    const IcthusIco = createElement('svg', {
        ...
        d: "M4723 3251 c-40 -25 -53 -49 -53 -99 0 -50 29 -88 78 -102 22 -6 179 -10 392 -10 401 0 409 1 443 72 22 45 12 91 -29 129 l-26 24 -386 3 c-370 2 -388 1 -419 -17z"
    }), createElement('path', {
        d: "M5867 4390 c-41 -36 -52 -78 -33 -125 8 -18 156 -271 330 -562 l315 -529 -209 -528 c-116 -290 -210 -538 -210 -552 0 -94 117 -149 189 -89 24 21 51 80 140 303 60 152 241 608 401 1012 314 790 309 773 259 826 -46 49 -130 52 -172 6 -9 -9 -75 -166 -147 -347 -72 -182 -135 -334 -139 -338 -4 -4 -131 200 -282 454 -200 337 -282 466 -304 480 -46 29 -98 25 -138 -11z"
    }), createElement('path', {
        d: "M7234 3921 c-19 -12 -37 -34 -43 -54 -15 -45 -17 -40 165 -389 80 -154 143 -285 141 -291 -3 -7 -100 -142 -216 -302 -196 -270 -211 -293 -211 -333 0 -35 6 -49 29 -73 48 -48 17 -55 573 120 142 44 273 87 292 95 36 15 66 59 66 96 0 53 -47 99 -101 100 -27 0 -364 -97 -467 -135 -17 -6 -19 -9 135 204 115 160 133 189 133 222 0 29 -25 86 -105 240 -58 111 -104 204 -101 206 2 3 92 -28 200 -67 209 -78 227 -80 271 -35 45 44 45 104 2 145 -25 25 -673 270 -711 270 -11 0 -35 -9 -52 -19z"
    }), createElement('path', {
        d: "M2308 3860 c-49 -38 -49 -37 -46 -678 l3 -604 33 -29 c54 -48 153 -35 180 26 17 37 17 1213 0 1250 -24 54 -121 74 -170 35z"
    }) );

    let IcthusIco = ( props ) => createElement( RichTextToolbarButton, {
            icon: IcthusIco,
            title: 'Cathopedia linker',
            onClick: function () {
                console.log( 'toggle format' );
                props.onChange(
                    toggleFormat( props.value, {
                        type: 'cathopedia-format/link-output',
                    } )
                );
            },
    ...
    registerFormatType( 'cathopedia-format/link-output', {
        title: 'Cathopedia link',
        tagName: 'samp',
        className: null,
        edit: IcthusIco
    } );
} )( wp.element, wp.editor, wp.richText );
